...
WORKSPACE="/home/tiger/workspaces/piano_transcription"

# Inference
MODEL_TYPE="Note_pedal"
NOTE_PEDAL_CHECKPOINT_PATH='/home/tiger/released_models/pub_piano_transcription/v3.0/note_F1=0.9677_pedal_F1=0.8658.pth'
CUDA_VISIBLE_DEVICES=3 python3 pytorch/inference.py --model_type=$MODEL_TYPE --checkpoint_path=$NOTE_PEDAL_CHECKPOINT_PATH --audio_path='resources/cut_liszt.mp3' --cuda

NOTE_PEDAL_CHECKPOINT_PATH=$WORKSPACE"/combined_models/google_note_pedal.pth"
CUDA_VISIBLE_DEVICES=3 python3 pytorch/inference.py --model_type=$MODEL_TYPE --checkpoint_path=$NOTE_PEDAL_CHECKPOINT_PATH --post_processor_type='onsets_frames' --audio_path='resources/cut_liszt.mp3' --cuda

# Combine
NOTE_CHECKPOINT_PATH=$WORKSPACE"/checkpoints/main/Regress_onset_offset_frame_velocity_CRNN/loss_type=regress_onset_offset_frame_velocity_bce/augmentation=none/max_note_shift=0/batch_size=12/300000_iterations.pth"
PEDAL_CHECKPOINT_PATH=$WORKSPACE"/checkpoints/main/Regress_pedal_CRNN/loss_type=regress_pedal_bce/augmentation=none/max_note_shift=0/batch_size=12/300000_iterations.pth"
NOTE_PEDAL_CHECKPOINT_PATH=$WORKSPACE"/combined_models/regress_note_pedal.pth"
python3 pytorch/combine_note_and_pedal_models.py --note_checkpoint_path=$NOTE_CHECKPOINT_PATH --pedal_checkpoint_path=$PEDAL_CHECKPOINT_PATH --output_checkpoint_path=$NOTE_PEDAL_CHECKPOINT_PATH

# Combine random target
NOTE_CHECKPOINT_PATH="/home/tiger/workspaces/piano_transcription/checkpoints/main_random_target/Regress_onset_offset_frame_velocity_CRNN/loss_type=regress_onset_offset_frame_velocity_bce/augmentation=none/max_note_shift=0/batch_size=12/140000_iterations.pth"
PEDAL_CHECKPOINT_PATH=$WORKSPACE"/checkpoints/main/Regress_pedal_CRNN/loss_type=regress_pedal_bce/augmentation=none/max_note_shift=0/batch_size=12/300000_iterations.pth"
NOTE_PEDAL_CHECKPOINT_PATH=$WORKSPACE"/combined_models/regress_random_note_pedal.pth"
python3 pytorch/combine_note_and_pedal_models.py --note_checkpoint_path=$NOTE_CHECKPOINT_PATH --pedal_checkpoint_path=$PEDAL_CHECKPOINT_PATH --output_checkpoint_path=$NOTE_PEDAL_CHECKPOINT_PATH

# Combine google
NOTE_CHECKPOINT_PATH="/home/tiger/workspaces/piano_transcription/checkpoints/main2/Regress_onset_offset_frame_velocity_CRNN/loss_type=google_onset_offset_frame_velocity_bce/augmentation=none/max_note_shift=0/batch_size=12/100000_iterations.pth"
PEDAL_CHECKPOINT_PATH=$WORKSPACE"/checkpoints/main/Regress_pedal_CRNN/loss_type=regress_pedal_bce/augmentation=none/max_note_shift=0/batch_size=12/300000_iterations.pth"
NOTE_PEDAL_CHECKPOINT_PATH=$WORKSPACE"/combined_models/google_note_pedal.pth"
python3 pytorch/combine_note_and_pedal_models.py --note_checkpoint_path=$NOTE_CHECKPOINT_PATH --pedal_checkpoint_path=$PEDAL_CHECKPOINT_PATH --output_checkpoint_path=$NOTE_PEDAL_CHECKPOINT_PATH

# Calculate prob
CUDA_VISIBLE_DEVICES=3 python3 pytorch/calculate_score_for_paper.py infer_prob --workspace=$WORKSPACE --model_type='Note_pedal' --checkpoint_path=$NOTE_PEDAL_CHECKPOINT_PATH --augmentation='none' --dataset='maestro' --split='test' --cuda

CUDA_VISIBLE_DEVICES=5 python3 pytorch/calculate_score_for_paper.py infer_prob --workspace=$WORKSPACE --model_type='Note_pedal' --checkpoint_path=$NOTE_PEDAL_CHECKPOINT_PATH --augmentation='random_target_none' --dataset='maestro' --split='test' --cuda

CUDA_VISIBLE_DEVICES=5 python3 pytorch/calculate_score_for_paper.py infer_prob --workspace=$WORKSPACE --model_type='Note_pedal' --checkpoint_path=$NOTE_PEDAL_CHECKPOINT_PATH --augmentation='google_none' --dataset='maestro' --split='test' --cuda
...
python3 pytorch/calculate_score_for_paper.py calculate_metrics --workspace=$WORKSPACE --model_type='Note_pedal' --augmentation='random_target_none' --dataset='maestro' --split='test'

python3 pytorch/calculate_score_for_paper.py calculate_metrics --workspace=$WORKSPACE --model_type='Note_pedal' --augmentation='google_none' --dataset='maestro' --split='test'
